...
LOGS_FOLDER = "Logs"
LOG_PATH_ENV_VAR = "IOTURING_LOG_DIR"
...
CONSOLE_LOG_LEVEL = int(os.environ.get("IOTURING_CONSOLE_LOG_LEVEL", LOG_INFO))
FILE_LOG_LEVEL = int(os.environ.get("IOTURING_FILE_LOG_LEVEL", LOG_INFO))
